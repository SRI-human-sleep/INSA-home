...
The report also includes the **[final outputs](#outputs)** reported in the main paper.
...
dat <- ema
dat$TIB.SSDc <- dat$TIB.SSD + 0.001
dat$TST.SSDc <- dat$TST.SSD + 0.001
dat$SO.num.SSDc <- dat$SO.num.SSD + 0.001
